        ...
        {isOpen && (
          <div className="md:hidden mt-4 space-y-2 border-t border-border pt-4">
            ...
            {user && (
              <button
                onClick={handleLogout}
                className="flex items-center gap-2 px-3 py-1.5 text-xs font-medium text-foreground hover:bg-red-50 hover:text-red-600 rounded-lg transition-colors w-full"
              >
                <LogOut className="h-4 w-4" />
                Logout
              </button>
