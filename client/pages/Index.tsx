...
export default function Index() {
  ...
  return (
    <div className="flex flex-col h-screen bg-white overflow-hidden">
      ...
      {/* Top Header Band */}
      <div className="flex-shrink-0 bg-gradient-to-r from-ocean-900 to-ocean-800 text-white px-4 sm:px-8 py-2 sm:py-3 border-b border-ocean-700">
        <div className="container mx-auto">
          <div className="flex items-center gap-4 sm:gap-8 h-20 sm:h-36">
            {/* Logo */}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-6 max-w-6xl mx-auto">
            {features.map((feature) => (
              <Link
                ...
                to={feature.href}
                className={`group relative overflow-hidden rounded-lg border-2 p-3 sm:p-6 transition-all duration-300 hover:shadow-lg hover:-translate-y-1 cursor-pointer ${feature.color}`}
              >
      ...
      {/* Bottom Benefits Bar */}
      <div className="flex-shrink-0 bg-ocean-950 text-white px-3 sm:px-6 py-3 sm:py-8 border-t border-ocean-800">
        <div className="container mx-auto">
