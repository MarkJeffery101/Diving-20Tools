...
export default function Index() {
  ...
  return (
    <div className="flex flex-col h-screen bg-white overflow-hidden">
      ...
      <div className="flex-grow overflow-y-auto px-2 sm:px-4 lg:px-2 py-1 sm:py-4 lg:py-1">
        <div className="container mx-auto">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2 sm:gap-3 lg:gap-2 max-w-full mx-auto">
            {features.map((feature) => (
              <Link
                key={feature.href + feature.title}
                to={feature.href}
                className={`group relative overflow-hidden rounded-lg border-2 p-2 sm:p-3 lg:p-2 transition-all duration-300 hover:shadow-lg hover:-translate-y-1 cursor-pointer ${feature.color}`}
              >
