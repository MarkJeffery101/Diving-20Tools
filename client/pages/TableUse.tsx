  ...
  const treatmentTables: TreatmentTableType[] = [
    {
      ...
      schedule: [
        ...
        { depth: '18-Sep', time: '30', gas: 'O₂', total: '01:45', otuOrOther: '307' },
        { depth: '9', time: '60', gas: 'O₂', total: '03:00', otuOrOther: '448' },
        { depth: '9', time: '60', gas: 'O₂', total: '04:15', otuOrOther: '590' },
        { depth: '9-0', time: '30', gas: 'O₂', total: '04:45', otuOrOther: '641' },
      ],
    ...
    },
    {
      ...
      schedule: [
        ...
        { depth: '18', time: '25', gas: 'O₂', total: '02:43', otuOrOther: '352' },
        { depth: '12', time: '45', gas: 'O₂', total: '04:38', otuOrOther: '646' },
        { depth: '12-0', time: '24', gas: 'O₂', total: '07:02', otuOrOther: '942' },
      ],
          ...
          <div className="mt-12 pt-8 border-t" style={{display: 'none'}}>
            ...
            <div className="mb-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <Card>
                  <CardHeader className="bg-green-50 border-b">
                    <CardTitle className="text-base">US Navy Oxygen Treatment Table T5</CardTitle>
                ...
                <Card>
                  <CardHeader className="bg-orange-50 border-b">
                    <CardTitle className="text-base">US Navy Oxygen Treatment Table T6</CardTitle>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <Card>
                  <CardHeader className="bg-gray-100 border-b">
                    <CardTitle className="text-base">Air Treatment Table T1A</CardTitle>
                ...
                <Card>
                  <CardHeader className="bg-gray-100 border-b">
                    <CardTitle className="text-base">Air Treatment Table T2A</CardTitle>
                ...
                <Card className="md:col-span-2 lg:col-span-1">
                  <CardHeader className="bg-gray-100 border-b">
                    <CardTitle className="text-base">Air Treatment Table T3</CardTitle>
