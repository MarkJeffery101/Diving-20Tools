                      ...
                      <div className="overflow-x-auto">
                        <table className="w-full text-xs border border-gray-300">
                          ...
                          <tbody className="text-xs">
                            ...
                            <tr className="bg-white hover:bg-gray-50"><td className="px-2 py-1 text-center border">24</td><td className="px-2 py-1 text-center border">25</td><td className="px-2 py-1 text-center border bg-purple-100">50/50</td><td className="px-2 py-1 text-center border">01:43</td><td className="px-2 py-1 text-center border">214</td></tr>
