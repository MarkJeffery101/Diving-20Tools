                    ...
                    <div>
                      ...
                      <div className="overflow-x-auto">
                        <table className="w-full text-xs border border-gray-300">
                          ...
                          <tbody className="text-xs">
                            <tr className="bg-white hover:bg-gray-50"><td className="px-2 py-1 text-center border">30</td><td className="px-2 py-1 text-center border">40</td><td className="px-2 py-1 text-center border bg-purple-100">50/50</td><td className="px-2 py-1 text-center border">00:43</td><td className="px-2 py-1 text-center border">100</td></tr>
