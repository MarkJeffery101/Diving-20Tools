      ...
      procedures: {
        ...
        emergency: {
          ...
          content: [
            ...
            {
              type: "item",
              text: "If repetitive interval > 4 hours: use surface decompression tables with oxygen (SOX15 or HSOX15)",
            },
            {
              type: "item",
              text: "Select table with diving depth deeper than EAD of nitrox dive",
            },
            {
              type: "item",
              text: "Possible even when in-water stops don't comply with surface/ox table",
            ...
            {
              type: "item",
              text: "If repetitive interval < 4 hours OR dive time longer than surface decompression tables: use crash dive procedure",
            },
          ],
        },
        crashDive: {
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        <ul className="text-sm text-gray-700 space-y-1">
                          <li>
                            • <strong>Most important:</strong> Administer oxygen
                            and fluids as soon as possible
                          </li>
                          <li>
                      ...
                      <div className="border-t pt-4">
                        ...
                        <ul className="text-sm text-gray-700 space-y-2">
                          <li>
                            <strong>Mild skin-bends (purple rash only):</strong>{" "}
                            CX12 or USN-5
                          </li>
                          <li>
                          ...
                          <li>
                            <strong>Type II DCS (serious neurological):</strong>{" "}
                      ...
                      <div className="bg-amber-100 border-l-4 border-amber-500 p-3 rounded">
                        ...
                        <p className="text-xs text-amber-800">
                          ...
                          only for oxygen delivery failure. Prevent this at all
                          costs.
                        </p>
                      </div>
                    </div>,
