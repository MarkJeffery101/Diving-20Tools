...
export default function TableUse() {
  ...
  const treatmentTables: TreatmentTableType[] = [
    ...
    },
    {
      ...
      schedule: [
        { depth: '8', time: '4', gas: 'Oxygen', total: '00:04', otuOrOther: '7' },
        { depth: '8-12', time: '2', gas: 'Oxygen', total: '00:06', otuOrOther: '12' },
        { depth: '12', time: '20', gas: 'Oxygen', total: '00:26', otuOrOther: '67' },
        { depth: '12', time: '5', gas: 'Air', total: '00:31', otuOrOther: '67' },
        { depth: '12', time: '20', gas: 'Oxygen', total: '00:51', otuOrOther: '122' },
        { depth: '12', time: '5', gas: 'Air', total: '00:56', otuOrOther: '122' },
        { depth: '12', time: '20', gas: 'Oxygen', total: '01:16', otuOrOther: '177' },
        { depth: '12', time: '5', gas: 'Air', total: '01:21', otuOrOther: '177' },
        { depth: '12', time: '20', gas: 'Oxygen', total: '01:41', otuOrOther: '232' },
        { depth: '12', time: '5', gas: 'Air', total: '01:46', otuOrOther: '232' },
        { depth: '12-0', time: '24', gas: 'Oxygen', total: '02:10', otuOrOther: '278' },
      ],
      headerBgColor: 'bg-blue-50',
      scheduleColumns: ['Pressure (msw)', 'Time (min)', 'Gas', 'Total (hr:min)', 'OTU'],
    },
    {
      id: 'usnt5',
      code: 'USN-5',
      ...
      schedule: [
        { depth: '18', time: '20', gas: 'Oxygen', total: '00:20', otuOrOther: '71' },
        { depth: '18', time: '5', gas: 'Air', total: '00:25', otuOrOther: '73' },
        { depth: '18', time: '20', gas: 'Oxygen', total: '00:45', otuOrOther: '144' },
        { depth: '18-9', time: '30', gas: 'Oxygen', total: '01:15', otuOrOther: '233' },
        { depth: '9', time: '5', gas: 'Air', total: '01:20', otuOrOther: '233' },
        { depth: '9', time: '20', gas: 'Oxygen', total: '01:40', otuOrOther: '280' },
        { depth: '9', time: '5', gas: 'Air', total: '01:45', otuOrOther: '280' },
        { depth: '9-0', time: '30', gas: 'Oxygen', total: '02:15', otuOrOther: '331' },
      ],
      headerBgColor: 'bg-green-50',
      scheduleColumns: ['Pressure (msw)', 'Time (min)', 'Gas', 'Total (hr:min)', 'OTU'],
    },
    {
      ...
      schedule: [
        ...
        { depth: '18', time: '5', gas: 'Air', total: '00:25', otuOrOther: '73' },
        { depth: '18', time: '20', gas: 'Oxygen', total: '00:45', otuOrOther: '144' },
        { depth: '18', time: '5', gas: 'Air', total: '00:50', otuOrOther: '145' },
        { depth: '18', time: '20', gas: 'Oxygen', total: '01:10', otuOrOther: '216' },
        { depth: '18', time: '5', gas: 'Air', total: '01:15', otuOrOther: '218' },
        { depth: '18-9', time: '30', gas: 'Oxygen', total: '01:45', otuOrOther: '307' },
        { depth: '9', time: '15', gas: 'Air', total: '02:00', otuOrOther: '307' },
        { depth: '9', time: '15', gas: 'Oxygen', total: '03:00', otuOrOther: '448' },
        { depth: '9', time: '15', gas: 'Air', total: '03:15', otuOrOther: '448' },
        { depth: '9-0', time: '15', gas: 'Oxygen', total: '04:15', otuOrOther: '590' },
        { depth: '9-0', time: '30', gas: 'Oxygen', total: '04:45', otuOrOther: '641' },
      ],
    ...
    },
    {
      ...
      useFor: 'Very serious decompression sickness and air embolism (only on prescription)',
      keyParameters: [
      ...
      schedule: [
        { depth: '30', time: '40', gas: '50/50', total: '00:43', otuOrOther: '100' },
        { depth: '30-24', time: '5', gas: 'Air', total: '00:48', otuOrOther: '103' },
        { depth: '30-24', time: '25', gas: '50/50', total: '01:13', otuOrOther: '160' },
        { depth: '24', time: '5', gas: 'Air', total: '01:18', otuOrOther: '162' },
        { depth: '24-18', time: '25', gas: '50/50', total: '01:43', otuOrOther: '214' },
        { depth: '24-18', time: '5', gas: 'Air', total: '01:48', otuOrOther: '216' },
        { depth: '24-18', time: '25', gas: '50/50', total: '02:13', otuOrOther: '262' },
        { depth: '18', time: '5', gas: 'Air', total: '02:18', otuOrOther: '263' },
        { depth: '18', time: '25', gas: 'Oxygen', total: '02:43', otuOrOther: '352' },
        { depth: '18', time: '5', gas: 'Air', total: '02:48', otuOrOther: '353' },
        { depth: '18', time: '25', gas: 'Oxygen', total: '03:13', otuOrOther: '442' },
        { depth: '18-12', time: '5', gas: 'Air', total: '03:18', otuOrOther: '442' },
        { depth: '18-12', time: '25', gas: 'Oxygen', total: '03:43', otuOrOther: '521' },
        { depth: '12', time: '10', gas: 'Air', total: '03:53', otuOrOther: '521' },
        { depth: '12', time: '45', gas: 'Oxygen', total: '04:38', otuOrOther: '646' },
        { depth: '12', time: '10', gas: 'Air', total: '04:48', otuOrOther: '646' },
        { depth: '12', time: '45', gas: 'Oxygen', total: '05:33', otuOrOther: '771' },
        { depth: '12', time: '10', gas: 'Air', total: '05:43', otuOrOther: '771' },
        { depth: '12', time: '45', gas: 'Oxygen', total: '06:28', otuOrOther: '896' },
        { depth: '12', time: '10', gas: 'Air', total: '06:38', otuOrOther: '896' },
        { depth: '12-0', time: '24', gas: 'Oxygen', total: '07:02', otuOrOther: '942' },
      ],
    ...
    },
    {
      ...
      useFor: 'Extremely serious symptoms (Type II) if oxygen unavailable with extended bottom time',
      keyParameters: [
        '• Descent rate: As fast as possible',
        '• Ascent rate: 1 minute between stops',
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-slate-50">
      ...
      <div className="px-4 sm:px-6 py-6 sm:py-8">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8" style={{display: 'none'}}>
            {infoCards.map((card) => (
                    ...
                    <div>
                      ...
                      <div className="overflow-x-auto">
                        <table className="w-full text-xs border border-gray-300">
                          ...
                          <tbody className="text-xs">
                            <tr className="bg-sky-100 hover:bg-sky-200"><td className="px-2 py-1 text-center border">18</td><td className="px-2 py-1 text-center border">20</td><td className="px-2 py-1 text-center border">O₂</td><td className="px-2 py-1 text-center border">00:20</td><td className="px-2 py-1 text-center border">71</td></tr>
                            ...
                            <tr className="bg-sky-100 hover:bg-sky-200"><td className="px-2 py-1 text-center border">18</td><td className="px-2 py-1 text-center border">20</td><td className="px-2 py-1 text-center border">O₂</td><td className="px-2 py-1 text-center border">00:45</td><td className="px-2 py-1 text-center border">144</td></tr>
                            <tr className="bg-sky-100 hover:bg-sky-200"><td className="px-2 py-1 text-center border">18-Sep</td><td className="px-2 py-1 text-center border">30</td><td className="px-2 py-1 text-center border">O₂</td><td className="px-2 py-1 text-center border">01:15</td><td className="px-2 py-1 text-center border">233</td></tr>
                            ...
                            <tr className="bg-sky-100 hover:bg-sky-200"><td className="px-2 py-1 text-center border">9</td><td className="px-2 py-1 text-center border">20</td><td className="px-2 py-1 text-center border">O₂</td><td className="px-2 py-1 text-center border">01:40</td><td className="px-2 py-1 text-center border">280</td></tr>
                            ...
                            <tr className="bg-sky-100 hover:bg-sky-200"><td className="px-2 py-1 text-center border">9-0</td><td className="px-2 py-1 text-center border">30</td><td className="px-2 py-1 text-center border">O₂</td><td className="px-2 py-1 text-center border">02:15</td><td className="px-2 py-1 text-center border">331</td></tr>
                          </tbody>
                        </table>
                      </div>
                    </div>
                      ...
                      <div className="overflow-x-auto">
                        <table className="w-full text-xs border border-gray-300">
                          ...
                          <tbody className="text-xs">
                            <tr className="bg-sky-100 hover:bg-sky-200"><td className="px-2 py-1 text-center border">18</td><td className="px-2 py-1 text-center border">20</td><td className="px-2 py-1 text-center border">O₂</td><td className="px-2 py-1 text-center border">00:20</td><td className="px-2 py-1 text-center border">71</td></tr>
                            <tr className="bg-gray-50 hover:bg-gray-100"><td className="px-2 py-1 text-center border">18</td><td className="px-2 py-1 text-center border">5</td><td className="px-2 py-1 text-center border">Air</td><td className="px-2 py-1 text-center border">00:25</td><td className="px-2 py-1 text-center border">73</td></tr>
                            <tr className="bg-sky-100 hover:bg-sky-200"><td className="px-2 py-1 text-center border">18</td><td className="px-2 py-1 text-center border">20</td><td className="px-2 py-1 text-center border">O₂</td><td className="px-2 py-1 text-center border">01:45</td><td className="px-2 py-1 text-center border">307</td></tr>
                            <tr className="bg-sky-100 hover:bg-sky-200"><td className="px-2 py-1 text-center border">9</td><td className="px-2 py-1 text-center border">60</td><td className="px-2 py-1 text-center border">O₂</td><td className="px-2 py-1 text-center border">03:00</td><td className="px-2 py-1 text-center border">448</td></tr>
                            <tr className="bg-sky-100 hover:bg-sky-200"><td className="px-2 py-1 text-center border">18</td><td className="px-2 py-1 text-center border">20</td><td className="px-2 py-1 text-center border">O₂</td><td className="px-2 py-1 text-center border">04:15</td><td className="px-2 py-1 text-center border">590</td></tr>
                            <tr className="bg-sky-100 hover:bg-sky-200"><td className="px-2 py-1 text-center border">9-0</td><td className="px-2 py-1 text-center border">30</td><td className="px-2 py-1 text-center border">O₂</td><td className="px-2 py-1 text-center border">04:45</td><td className="px-2 py-1 text-center border">641</td></tr>
                          </tbody>
                        </table>
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <div className="overflow-x-auto">
                        <table className="w-full text-xs border border-gray-300">
                          ...
                          <tbody className="text-xs">
                            <tr className="bg-purple-100 hover:bg-purple-200"><td className="px-2 py-1 text-center border">30</td><td className="px-2 py-1 text-center border">40</td><td className="px-2 py-1 text-center border">50/50</td><td className="px-2 py-1 text-center border">00:43</td><td className="px-2 py-1 text-center border">100</td></tr>
                            ...
                            <tr className="bg-purple-100 hover:bg-purple-200"><td className="px-2 py-1 text-center border">24</td><td className="px-2 py-1 text-center border">25</td><td className="px-2 py-1 text-center border">50/50</td><td className="px-2 py-1 text-center border">01:43</td><td className="px-2 py-1 text-center border">214</td></tr>
                            <tr className="bg-sky-100 hover:bg-sky-200"><td className="px-2 py-1 text-center border">18</td><td className="px-2 py-1 text-center border">25</td><td className="px-2 py-1 text-center border">O₂</td><td className="px-2 py-1 text-center border">02:43</td><td className="px-2 py-1 text-center border">352</td></tr>
                            <tr className="bg-sky-100 hover:bg-sky-200"><td className="px-2 py-1 text-center border">18</td><td className="px-2 py-1 text-center border">20</td><td className="px-2 py-1 text-center border">O₂</td><td className="px-2 py-1 text-center border">04:38</td><td className="px-2 py-1 text-center border">646</td></tr>
                            <tr className="bg-sky-100 hover:bg-sky-200"><td className="px-2 py-1 text-center border">12-0</td><td className="px-2 py-1 text-center border">24</td><td className="px-2 py-1 text-center border">O₂</td><td className="px-2 py-1 text-center border">07:02</td><td className="px-2 py-1 text-center border">942</td></tr>
                          </tbody>
                        </table>
                      </div>
                    </div>
