...
const tablesData: Level1Item[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { name: "US Navy Oxygen Treatment Table T5", code: "USN-T5" },
      { name: "US Navy Oxygen Treatment Table T6", code: "USN-T6" },
      { name: "Air Treatment Table T1A", code: "AIR-T1A" },
      { name: "Air Treatment Table T2A", code: "AIR-T2A" },
      { name: "Air Treatment Table T3", code: "AIR-T3" },
    ],
  },
];
